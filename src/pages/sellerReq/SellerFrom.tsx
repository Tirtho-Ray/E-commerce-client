...
export default function SellerForm() {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <input {...register("bankDetails.accountNumber")} placeholder="Account Number" className="border p-2 w-full rounded-md" />
                <input {...register("bankDetails.accountHolderName")} placeholder="Account Holder Name" className="border p-2 w-full rounded-md" />
